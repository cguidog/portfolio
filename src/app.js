...
store.dispatch(addProject({name: 'Weather App', thumbnail: '/resources/weather_app.png', git: 'https://github.com/cguidog/weather-app', description: 'App created with Javascript to show local weather.', link: 'https://codepen.io/cguidog/full/LJPZry/', tool:'JavaScript'}))
